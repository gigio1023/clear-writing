...
Cut the opener when nothing is lost. Keep a personal aside that adds genuine
context or character.

**Padded verb phrase.** Prefer the direct verb when phrases such as "serves as",
...
the consequence. Replace only with supported scope or effect.

**Insider performance.** Openers such as "what nobody tells you" and "the part
everyone misses" manufacture authority. State the supported point without
claiming universal ignorance.

**Withheld conclusion.** Repeated "not X, not Y, but Z", self-answered questions,
colon reveals, and stacked fragments can delay the claim. State the conclusion
once unless the contrast corrects a real misconception or belongs to the
writer's established voice.

**Participial afterthought.** An `-ing` clause at the end of a sentence often
asserts an unproved result or causal relation. Keep it if the subject and
relation are unambiguous. Otherwise make the relation explicit, split the
sentence, or remove the unsupported analysis.

**Mechanical closure.** Remove conclusion labels, recap paragraphs, future
outlook sections, and aphoristic kickers that add no decision or action. Keep a
conclusion when the genre expects synthesis and the synthesis does new work.
...
- Does the edit preserve the claim's force, logical relation, and attribution?
- Does this construction recur as part of the writer's voice?
- Is it normal or required in this English variety, genre, or domain?
- Does the new version sound more specific only because it invented detail?

When the first three answers argue for keeping the span, keep it. When the last
answer is yes, revert the invented specificity.
